...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    if(isset($_POST['action']) && $_POST['action'] === 'create') {
        ...
        $stmt->bind_param("ssssi", $title, $message, $department, $year, $_SESSION['user_id']);
        
        if($stmt->execute()) {
            setAlert('success', 'Notification created successfully!');
        } else {
            setAlert('error', 'Failed to create notification.');
        }
        $stmt->close();
    }
}
...
<head>
    ...
    <title>Notifications Management - Developer Student Club</title>
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $notification['department']; ?></td>
                                    <td><?php echo $notification['year']; ?></td>
                                    <td><?php echo date('M d, Y', strtotime($notification['created_at'])); ?></td>
                                    <td>
                                        <button class="btn btn-small btn-danger" onclick="deleteNotification(<?php echo $notification['id']; ?>)">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="department" name="department" required>
                            ...
                            <option value="ALDS">AI & Data Science</option>
                        </select>
                    </div>
