...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2025 at 08:50 AM
...
(1, 'dfg', 'rlakare18@gmail.com', '+918767195562', 'dfsg', 'egregregg', 0, '2025-07-14 06:29:34');
...
INSERT INTO `daily_problems` (`id`, `date`, `platform`, `difficulty`, `problem_title`, `problem_url`, `points`, `created_at`) VALUES
(1, '2025-07-14', 'leetcode', 'easy', 'Two Sum', 'https://leetcode.com/problems/two-sum/', 10, '2025-07-14 06:23:49'),
(2, '2025-07-14', 'leetcode', 'medium', 'Add Two Numbers', 'https://leetcode.com/problems/add-two-numbers/', 20, '2025-07-14 06:23:49'),
(3, '2025-07-14', 'leetcode', 'hard', 'Median of Two Sorted Arrays', 'https://leetcode.com/problems/median-of-two-sorted-arrays/', 30, '2025-07-14 06:23:49'),
(4, '2025-07-14', 'hackerrank', 'easy', 'Simple Array Sum', 'https://www.hackerrank.com/challenges/simple-array-sum/', 10, '2025-07-14 06:23:49'),
(5, '2025-07-14', 'hackerrank', 'medium', 'Climbing the Leaderboard', 'https://www.hackerrank.com/challenges/climbing-the-leaderboard/', 20, '2025-07-14 06:23:49'),
(6, '2025-07-14', 'hackerrank', 'hard', 'Matrix Layer Rotation', 'https://www.hackerrank.com/challenges/matrix-rotation-algo/', 30, '2025-07-14 06:23:49');
...
INSERT INTO `problem_submissions` (`id`, `student_id`, `problem_id`, `submission_file`, `status`, `points_awarded`, `admin_comment`, `submitted_at`, `reviewed_at`, `reviewed_by`) VALUES
(1, 5, 1, '1752474428_5_1.js', 'pending', 0, NULL, '2025-07-14 06:27:08', NULL, NULL);
...
--
-- Indexes for table `daily_problems`
--
ALTER TABLE `daily_problems`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_daily_problem` (`date`,`platform`,`difficulty`);
...
ALTER TABLE `problem_submissions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_submission` (`student_id`,`problem_id`),
...
--
-- AUTO_INCREMENT for table `daily_problems`
--
ALTER TABLE `daily_problems`
...
--
ALTER TABLE `problem_submissions`
  ADD CONSTRAINT `problem_submissions_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `problem_submissions_ibfk_2` FOREIGN KEY (`problem_id`) REFERENCES `daily_problems` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `problem_submissions_ibfk_3` FOREIGN KEY (`reviewed_by`) REFERENCES `admins` (`id`) ON DELETE SET NULL;
